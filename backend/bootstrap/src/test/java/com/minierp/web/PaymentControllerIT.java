...
@ActiveProfiles("test")
@DisplayName("PaymentController — HTTP layer")
class PaymentControllerIT {
    ...
    void seed() {
        ...
        token = jwtService.issueAccessToken(new CurrentUser(
                ...
                Set.of(), Set.of("payment:read", "payment:create", "payment:update", "payment:cancel")));
    }

    @Test
    @DisplayName("GET /payments returns 200 with empty page")
    void listPayments_returns200() throws Exception {
