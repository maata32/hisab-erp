...
@ActiveProfiles("test")
@DisplayName("PricingController — HTTP layer")
class PricingControllerIT {
    ...
    void seed() {
        ...
        token = jwtService.issueAccessToken(new CurrentUser(
                ...
                Set.of(), Set.of("product:read", "price:update")));
    }

    @Test
    @DisplayName("GET /pricing/tiers returns 200")
    void listTiers_returns200() throws Exception {
        mockMvc.perform(get("/api/v1/pricing/tiers").header("Authorization", "Bearer " + token))
