package com.minierp.shared.openapi;
...
public class OpenApiConfig {
    ...
    @Value("${spring.application.name:mini-erp}")
    ...
    public OpenAPI openApi() {
        return new OpenAPI()
                .info(new Info()
                        .title("Mini-ERP API")
                        .description("Multi-tenant SaaS Mini-ERP for Mauritanian retail/wholesale.")
                        .version(appVersion)
                        .contact(new Contact().name("Mini-ERP team").email("noreply@minierp.local"))
