...
import com.hisaberp.identity.api.AuthController.LoginRequest;
import com.hisaberp.identity.api.AuthController.LoginResponse;
import com.hisaberp.identity.api.AuthController.PlatformLoginRequest;
import com.hisaberp.identity.events.UserLoggedInEvent;
import com.hisaberp.identity.security.JwtProperties;
import com.hisaberp.identity.security.JwtService;
import com.hisaberp.identity.security.PasswordHasher;
import com.hisaberp.shared.audit.AuditEvent;
import com.hisaberp.shared.audit.RequestContext;
import com.hisaberp.shared.error.ForbiddenException;
...
public class AuthService {
    ...
    private TenantSnapshot resolveTenant(String tenantCode) {
        ...
        return tenantLookup.findByCode(tenantCode)
                .orElseThrow(() -> new com.hisaberp.shared.error.NotFoundException(
