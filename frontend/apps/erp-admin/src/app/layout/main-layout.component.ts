...
export class MainLayoutComponent {
  ...
  protected readonly items: NavItem[] = [
    ...
    { label: 'nav.warehouses', icon: 'pi pi-warehouse', path: '/warehouses', permission: 'inventory:read' },
    { label: 'nav.stock', icon: 'pi pi-database', path: '/stock', permission: 'inventory:read' },
    ...
    { label: 'nav.priceTiers', icon: 'pi pi-percentage', path: '/price-tiers', permission: 'pricing:read' },
    { label: 'nav.notifConfig', icon: 'pi pi-bell', path: '/notifications-config', permission: 'settings:read' },
