...
export class MainLayoutComponent {
  ...
  protected readonly items: NavItem[] = [
    ...
    { label: 'nav.quotes', icon: 'pi pi-file', path: '/quotes', permission: 'sale:read' },
    { label: 'nav.orders', icon: 'pi pi-shopping-cart', path: '/orders', permission: 'sale:read' },
    { label: 'nav.invoices', icon: 'pi pi-receipt', path: '/invoices', permission: 'invoice:read' },
